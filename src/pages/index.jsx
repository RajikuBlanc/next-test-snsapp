...
export default function Home(providers) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      {session && (
        <>
          <button onClick={() => signOut()} className="mt-4 text-xl text-center">
            ログアウト
          </button>
          <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
            ...
            <p className="mt-3 text-2xl">
              ...
              <code className="p-3 font-mono text-lg bg-gray-100 rounded-md">pages/index.jsx</code>
            </p>
      ...
      {!session && (
        <button onClick={() => signIn()} className="mt-4 text-xl text-center">
          ログインしてください
        </button>
      )}
